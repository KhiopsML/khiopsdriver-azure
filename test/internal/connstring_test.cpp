...
TEST_P(ConnectionStringTest, ParseValidConnString) {
  ...
  ASSERT_EQ(az::util::connstr::ConnectionString::ParseConnectionString(
      &actual, sValidConnString, bIsEmulatedStorage), 0);
  az::util::connstr::ConnectionString expected(
      "devstoreaccount1",
      "Eby8vdM02xNOcqFlqUwJPLlmEtlCDXJ1OUzFT50uSRZ6IFsuFq2UVErCz4I6tq/"
      "K1SZFPTOtr/KBHBeksoGMGw==");
  expected.blobEndpointPtr = std::make_unique<Azure::Core::Url>("http://127.0.0.1:10000/devstoreaccount1");
  ASSERT_EQ(actual, expected);
}

TEST_P(ConnectionStringTest, ParseValidConnStringWithoutTrailingSemicolon) {
  az::util::connstr::ConnectionString actual;
      ASSERT_EQ(az::util::connstr::ConnectionString::ParseConnectionString(&actual,
          sValidConnStringWithoutTrailingSemicolon, bIsEmulatedStorage), 0);
  az::util::connstr::ConnectionString expected(
      "devstoreaccount1",
      "Eby8vdM02xNOcqFlqUwJPLlmEtlCDXJ1OUzFT50uSRZ6IFsuFq2UVErCz4I6tq/"
      "K1SZFPTOtr/KBHBeksoGMGw==");
...
TEST_P(ConnectionStringTest, ParseAzuriteValidConnString) {
  az::util::connstr::ConnectionString actual;ASSERT_EQ(
      az::util::connstr::ConnectionString::ParseConnectionString(&actual,
          sValidAzuriteConnString, bIsEmulatedStorage), 0);
  az::util::connstr::ConnectionString expected(
      "devstoreaccount1",
      "Eby8vdM02xNOcqFlqUwJPLlmEtlCDXJ1OUzFT50uSRZ6IFsuFq2UVErCz4I6tq/"
      "K1SZFPTOtr/KBHBeksoGMGw==");
  expected.blobEndpointPtr = std::make_unique<Azure::Core::Url>("http://localhost:10000/devstoreaccount1");
  ASSERT_EQ(actual, expected);
}
...
TEST_P(ConnectionStringTest, ParseIllFormedConnString) {
    az::util::connstr::ConnectionString actual;
    ASSERT_EQ(az::util::connstr::ConnectionString::ParseConnectionString(&actual,
        sIllFormedConnString, bIsEmulatedStorage), -1);
}

TEST_P(ConnectionStringTest, ParseConnStringMissingAccountName) {
    az::util::connstr::ConnectionString actual;
    ASSERT_EQ(az::util::connstr::ConnectionString::ParseConnectionString(&actual,
        sConnStringMissingAccountName, bIsEmulatedStorage), -1);
}

TEST_P(ConnectionStringTest, ParseConnStringMissingAccountKey) {
    az::util::connstr::ConnectionString actual;
    ASSERT_EQ(az::util::connstr::ConnectionString::ParseConnectionString(&actual,
        sConnStringMissingAccountKey, bIsEmulatedStorage), -1);
}
...
TEST(ConnectionStringTest, ParseConnStringMissingBlobEndpoint) {
  ...
  ASSERT_EQ(actual, expected);
    ...
    ASSERT_EQ(az::util::connstr::ConnectionString::ParseConnectionString(&actual,
        sConnStringMissingBlobEndpoint, true), -1);
}
